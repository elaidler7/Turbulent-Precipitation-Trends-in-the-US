...
#In the code below, I discovered that row names have either 10 or 11 digits.This is because the state ID's at the beginning have either 1 or 2 digits, depending on whether it is single- or double-digit.
sum_10 = 0
sum_11 = 0
...
#Finding Maximum Values (The Highest Monthly Precipitation Measurement):
